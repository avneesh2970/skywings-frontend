    ...
    >
      ...
      <div className="relative flex items-center pl-8 h-full">
        <h3 className="text-3xl font-semibold px-2 py-1 text-white bg-clip-text bg-gradient-to-r from-blue-500 to-green-500 -mt-10">
          ...
          <button>
            <div className='gap-3.5 mt-14 text-base text-white items-center bg-blue-500 px-4 py-1 rounded-lg flex cursor-pointer' onClick={() => window.open('https://youtu.be/qFrYTlhEaiw', '_blank')} >
