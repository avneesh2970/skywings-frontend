...
function PrivacyPolicy() {
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <p>
        <strong>Effective Date:</strong> <span className="ml-4">01-01-2025</span>
      </p>
      <p>
        <strong>Last Updated:</strong><span className="ml-4">08-04  -2025</span>
      </p>

      <h2 className="text-xl font-semibold mt-4">Introduction</h2>
      <p>
        At AssuredJob.com , we use cookies and similar tracking technologies to
        improve your browsing experience, analyze website traffic, and
        personalize content. This Cookie Policy explains what cookies are, how
      ...
      <p>
        ...
        information. These help us understand how users interact with our site,
        enhance user experience, and support our advertising efforts.
      </p>
      ...
      <ul className="list-disc ml-6">
        <li>
          These cookies help us measure website traffic, analyze user behavior,
      ...
      <ul className="list-disc ml-6">
        <li>
          These cookies track your browsing behavior to display relevant job
      ...
      <p>
        Some third-party services we use (such as Google, LinkedIn, and
        Facebook) may place cookies on your device when you interact with our
        site.
      </p>
      ...
      <p>
        ...
        that restricting cookies may impact your experience on AssuredJob.com.
      </p>
      <p>
        <strong>Steps to Disable Cookies in Browsers:</strong>
      </p>
      <ul className="list-disc ml-6">
        <li>
